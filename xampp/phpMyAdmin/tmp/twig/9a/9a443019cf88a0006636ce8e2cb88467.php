...
class __TwigTemplate_71087551e1440ce24028b11e00fa9705 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        ";
            ...
            <td class=\"value text-monospace text-right\">
              <span class=\"formatted\">
                ...
                ";
                // line 91
                if ((is_string($__internal_compile_0 = twig_get_attribute($this->env, $this->source, $context["variable"], "name", [], "any", false, false, false, 91)) && is_string($__internal_compile_1 = "%") && ('' === $__internal_compile_1 || $__internal_compile_1 === substr($__internal_compile_0, -strlen($__internal_compile_1))))) {
                    // line 92
                    echo "                  ";

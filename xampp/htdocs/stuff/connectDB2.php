...
$conn = new mysqli('localhost', 'createid', 'hifrneds@#1232', 'specialapps');
...
if($right)
{
	$search_sql = $conn->prepare("SELECT * FROM apps where EMAIL = ?");
    ...
    {
        $insert_sql = $conn->prepare("INSERT INTO apps (CHINESENAME, ENGLISHNAME, GENDER, DOB, ADDRESS, POB, OCCUPATION, VENUE, EMAIL) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");  
